...
DEFAULT_USER = "neo4j"
DEFAULT_PASSWORD = "shrey1306"
DEFAULT_QUERY = "MATCH p=()-->() RETURN p;"
DEFAULT_OUTPUT_FILE = "test.html"

def visualize_neo4j_graph(uri=DEFAULT_URI, user=DEFAULT_USER, password=DEFAULT_PASSWORD,
                          query=DEFAULT_QUERY, output_file=DEFAULT_OUTPUT_FILE):
    """
